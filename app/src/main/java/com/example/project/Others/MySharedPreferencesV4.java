...
public class MySharedPreferencesV4 {


    public interface KEYS {
        public final static String SP_FAMILY_MEMBERS = "SP_FAMILY_MEMBERS";
        public final static String SP_LAST_GAME = "SP_LAST_GAME";
    }



    private static MySharedPreferencesV4 instance;
    private SharedPreferences prefs;

    public static MySharedPreferencesV4 getInstance() {
        return instance;
    }

    private MySharedPreferencesV4(Context context) {
        prefs = context.getApplicationContext().getSharedPreferences("APP_SP_DB", Context.MODE_PRIVATE);
    }

    private MySharedPreferencesV4(Context context, String sharePreferencesName) {
        prefs = context.getApplicationContext().getSharedPreferences(sharePreferencesName, Context.MODE_PRIVATE);
    }

    public static MySharedPreferencesV4 initHelper(Context context) {
        if (instance == null)
            instance = new MySharedPreferencesV4(context);
        return instance;
    }

    public static MySharedPreferencesV4 initHelper(Context context, String sharePreferencesName) {
        if (instance == null)
            instance = new MySharedPreferencesV4(context, sharePreferencesName);
        return instance;
    }
